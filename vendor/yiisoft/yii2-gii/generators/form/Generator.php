...
class Generator extends \yii\gii\Generator
{
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'viewName' => 'This is the view name with respect to the view path. For example, <code>people/index</code> would generate a <code>people/index.php</code> view file under the view path.',
