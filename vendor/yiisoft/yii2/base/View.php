...
class View extends Component
{
     ...
     *
     * - path alias (e.g. "@app/views/people/index");
     * - absolute path within application (e.g. "//people/index"): the view name starts with double slashes.
     *   The actual view file will be looked for under the [[Application::viewPath|view path]] of the application.
     * - absolute path within current module (e.g. "/people/index"): the view name starts with a single slash.
