 ...
 * then the themed version for a view file `@app/views/people/IndexController.php` will be
 * `@app/themes/basic/people/IndexController.php`.
 *
 ...
 * ~~~
 *
 * In this case, the themed version could be either `@app/themes/christmas/people/IndexController.php` or
 * `@app/themes/basic/people/IndexController.php`. The former has precedence over the latter if both files exist.
 *
