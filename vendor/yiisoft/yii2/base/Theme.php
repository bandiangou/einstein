 ...
 * then the themed version for a view file `@app/views/people/index.php` will be
 * `@app/themes/basic/people/index.php`.
 *
 ...
 * ~~~
 *
 * In this case, the themed version could be either `@app/themes/christmas/people/index.php` or
 * `@app/themes/basic/people/index.php`. The former has precedence over the latter if both files exist.
 *
