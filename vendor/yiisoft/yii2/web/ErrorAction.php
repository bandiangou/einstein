 ...
 * ```
 *
 * Then, create a view file for this action. If the route of your error action is `people/error`, then
 * the view file should be `views/people/error.php`. In this view file, the following variables are available:
 *
 * - `$name`: the error name
...
class ErrorAction extends Action
{
     ...
     * would be "error", and the corresponding view file would be "views/people/error.php".
     */
    public $view;
    /**
