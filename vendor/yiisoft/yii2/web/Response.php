...
class Response extends \yii\base\Response
{
     ...
     * an error message like this: "Internet Explorer was not able to open this Internet people. The requested people
     ...
     * - an array in the format of `[$route, ...name-value pairs...]` (e.g. `['people/index', 'ref' => 1]`).
