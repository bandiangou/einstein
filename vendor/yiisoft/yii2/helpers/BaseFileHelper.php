...
class BaseFileHelper
{
     ...
     *   For example, "views/*.php" matches "views/IndexController.php" but not "views/controller/IndexController.php".
     *   A leading slash matches the beginning of the pathname. For example, "/*.php" matches "IndexController.php" but not "views/start/IndexController.php".
