...
class BaseUrl
{
     ...
     *
     * You may specify the route as a string, e.g., `people/index`. You may also use an array
     ...
     * ```
     *
     * A route may be either absolute or relative. An absolute route has a leading slash (e.g. `/people/index`),
     * while a relative route has none (e.g. `people/index` or `index`). A relative route will be converted
     ...
     * - If the route has no leading slash (e.g. `people/index`), it is considered to be a route relative
     ...
     * echo Url::toRoute('people/index', true);
     *
     ...
     * ```
     *
     * @param string|array $route use a string to represent a route (e.g. `index`, `people/index`),
     * or an array to represent a route with query parameters (e.g. `['people/index', 'param1' => 'value1']`).
     ...
     *   `['people/index']`, `['post/index', 'page' => 2]`. Please refer to [[toRoute()]] for more details
